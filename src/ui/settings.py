...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayout.addWidget(self.red_depth, 5, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.red_increment, 8, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.black_increment, 8, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.red_steps, 7, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.black_time, 6, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.delay, 9, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.black_steps, 7, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.red_time, 6, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.black_depth, 5, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.standard_method, 9, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.mode, 4, 1, 1, 1)
